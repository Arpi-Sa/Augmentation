...
* proceeds the frames
* if the labels are not 'fine', they stayn in the same folder unchanged
...
def process_frames(folder, new_directory='../changed_frames', proc_type='_changed'):
        ...
        for imtype in image_types:
            ...
            if os.path.exists(imgfile):
                if filename.endswith(imtype):
                    ...
                    x_to_extend, y_to_extend, extend_method, is_possible = proceed_frame(frame, weapons)
